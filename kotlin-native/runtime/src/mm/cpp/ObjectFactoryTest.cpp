...
public:
    ...
    void* DefaultAlloc(size_t size, size_t alignment) { return allocateInObjectSpace(1, size, alignment); }

    void DefaultFree(void* instance) { deallocateInObjectSpace(instance); }
};
